...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white px-4">
      <ToastContainer />
      <motion.div
        className="bg-white shadow-lg border border-gray-200 rounded-xl p-0 max-w-md w-full"
      ...
      >
        <form
          ...
          className="bg-blue-50 rounded-xl p-8 space-y-6"
        >
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:outline-none pr-10"
            />
            <span
